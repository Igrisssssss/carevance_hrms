...
export const topNavigation: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Employees', to: '/payroll/employees', icon: Users, adminOnly: true },
      { label: 'Components', to: '/payroll/components', icon: SquareKanban, adminOnly: true },
      { label: 'Structures', to: '/payroll/structures', icon: Layers3, adminOnly: true },
      { label: 'Adjustments', to: '/payroll/adjustments', icon: Fingerprint, adminOnly: true },
